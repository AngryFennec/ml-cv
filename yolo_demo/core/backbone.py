...
def darknet53(input_data, trainable):
    ...
    with tf.variable_scope("darknet"):
        ...
        input_data = common.PEP(
            input_data, 150, 150, 56, name="PEP3", stride=1
        )
        ...
        input_data = common.PEP(
            input_data, 150, 150, 73, name="PEP4", stride=1
        )
        input_data = common.PEP(
            input_data, 150, 150, 71, name="PEP5", stride=1
        )
        input_data = common.PEP(
            input_data, 150, 150, 75, name="PEP6", stride=1
        )
        route_1 = input_data

        input_data = common.EP(input_data, 150, 325, name="EP2", stride=2)
        input_data = common.PEP(
            input_data, 325, 325, 132, name="PEP7", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 124, name="PEP8", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 141, name="PEP9", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 140, name="PEP10", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 137, name="PEP11", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 135, name="PEP12", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 133, name="PEP13", stride=1
        )
        input_data = common.PEP(
            input_data, 325, 325, 140, name="PEP14", stride=1
        )
        route_2 = input_data

        input_data = common.EP(input_data, 325, 545, name="EP3", stride=2)
        input_data = common.PEP(
            input_data, 545, 545, 276, name="PEP15", stride=1
        )
        input_data = common.convolutional(
            input_data,
        ...
        input_data = common.PEP(
            input_data, 489, 469, 213, name="PEP16", stride=1
        )
        input_data = common.convolutional(
            input_data,
